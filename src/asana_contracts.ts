...
export const CustomFieldSchema = z.object({
  ...
  asana_created_field: z.string().nullable(),
  id_prefix: z.string().nullable(),
  enum_options: z.array(EnumOptionSchema),
  multi_enum_options: z.array(EnumOptionSchema),
  enum_value: EnumOptionSchema.nullish(),
  multi_enum_values: z.array(EnumOptionSchema),
  date_value: z
    .object({
  ...
  custom_id_value: z.string().nullable(),
  reference_value: z.array(CompactResourceSchema),
  is_formula_field: z.boolean(),
});
